...
function renderCard($cardName){
	...
	if($cardMayCollapse == 1){
		...
		echo "<div id=\"$cardName\Header\" class=\"card-header\" style=\"background-color:#$trimColor;\">".$cardTitle."</div></a>\n"; }		// adds /a
	else{
		echo "<div id=\"$cardName\Header\" class=\"card-header\">".$cardTitle."</div>\n";			// not collapsible
	}
	...
	if($cardMayCollapse == 1){
		...
		echo "<div class=\"card-body\" id=\"".$cardName."CardBody\">\n";					// not collapsible
	}
